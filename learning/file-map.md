...
- backend/server.js — known (2026-08-06) — Express server; auth (signup/login) + requireAuth-protected sessions routes → [[express]] [[routes]] [[api]] [[sql]] [[crud]] [[password-hashing-bcrypt]] [[jwt]] [[protected-routes]] [[middleware]] [[environment-variables]]
